          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input type="password" value={newPw} onChange={e => setNewPw(e.target.value)} placeholder="Min. 6 caractères" required
                className="w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3.5 text-sm text-white placeholder:text-white/20 focus:border-lime/50 focus:outline-none focus:ring-1 focus:ring-lime/30 transition" />
            </div>
            <div>
